...
namespace AElf.Contracts.BingoGameContract
{
    ...
    public partial class BingoGameContract : BingoGameContractContainer.BingoGameContractBase
    {
        ...
        {
            // The "Assert" method is used to check conditions.
            ...
            // In the contract, all "set" and "get" methods are implemented using the state. For specific usage, please refer to the comments in the state class.
            State.PlayerInformation[Context.Sender] = information;
            return new Empty();
        }

        // The "Initialize" method is commonly used for initialization.
        ...
        // The "Quit" method is used to exit the game, and it clears the current player's address.
